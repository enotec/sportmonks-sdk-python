...
class TestEnotec:
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "sportmonks/_legacy_response.py",
                        "sportmonks/_response.py",
                        # pydantic.BaseModel.model_dump || pydantic.BaseModel.dict leak memory for some reason.
                        "sportmonks/_compat.py",
    ...
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        respx_mock.get("/v3/core/continents/1").mock(side_effect=httpx.TimeoutException("Test timeout error"))

        with pytest.raises(APITimeoutError):
            self.client.get(
                "/v3/core/continents/1", cast_to=httpx.Response, options={"headers": {RAW_RESPONSE_HEADER: "stream"}}
            )
    ...
    def test_retrying_status_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        respx_mock.get("/v3/core/continents/1").mock(return_value=httpx.Response(500))
    ...
    def test_retries_taken(
        ...
        respx_mock.get("/v3/core/continents/1").mock(side_effect=retry_handler)

        response = client.core.continents.with_raw_response.retrieve(continent_id="1", version="v3")
    ...
    def test_omit_retry_count_header(
        ...
        response = client.core.continents.with_raw_response.retrieve(
            continent_id="1", version="v3", extra_headers={"x-stainless-retry-count": Omit()}
        )
    ...
    def test_overwrite_retry_count_header(
        ...
        response = client.core.continents.with_raw_response.retrieve(
            continent_id="1", version="v3", extra_headers={"x-stainless-retry-count": "42"}
        )
...
class TestAsyncEnotec:
    ...
    async def test_retries_taken(
        ...
        response = await client.core.continents.with_raw_response.retrieve(continent_id="1", version="v3")
    ...
    async def test_omit_retry_count_header(
        ...
        response = await client.core.continents.with_raw_response.retrieve(
            continent_id="1", version="v3", extra_headers={"x-stainless-retry-count": Omit()}
        )
